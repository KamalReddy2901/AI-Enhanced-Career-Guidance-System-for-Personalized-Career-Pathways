...
export function AssessmentHubPage() {
  ...
  return <div className="min-h-screen bg-[var(--paper)] px-6 py-16 md:py-24"><GuidanceEntrance className="mx-auto max-w-4xl">
    <header className="mb-12 grid gap-6 border-b-2 border-[var(--ink)] pb-8 md:grid-cols-[1fr_auto]"><div><div className="label-caps">CareerCase · {c.desk}</div><h1 className="font-display mt-3 text-5xl leading-[1.05] tracking-tighter md:text-6xl">{t("assess")}</h1><p className="mt-5 max-w-[65ch] text-base leading-relaxed text-[var(--ink-soft)]">{c.intro}</p></div><StickFigure pose="reading" size={112}/></header>
