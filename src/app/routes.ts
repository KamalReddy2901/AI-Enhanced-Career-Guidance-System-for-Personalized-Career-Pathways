...
const CareerWorkspacePage = lazy(() => import("./sih/SihProductionPages").then((m) => ({ default: m.CareerWorkspacePage })));
const OpportunitiesPage = lazy(() => import("./sih/SihStudentProductionPages").then((m) => ({ default: m.OpportunitiesPage })));
const OpportunityDetailPage = lazy(() => import("./sih/SihStudentProductionPages").then((m) => ({ default: m.OpportunityDetailPage })));
const ReadinessPage = lazy(() => import("./sih/SihStudentProductionPages").then((m) => ({ default: m.ReadinessPage })));
