...
export function localizedTradeoff(route: PathwayRoute, lang: Language): string {
  ...
  const copy = lang === 'hi'
    ? {direct:'सबसे तेज़ मार्ग; इसमें स्वयं प्रमाण तैयार करना और केंद्रित सीखना आवश्यक है।', stepping_stone:'कम जोखिम वाला मार्ग; निगरानी में अभ्यास करते हुए आय और प्रमाण बनाए रखता है।', qualification_first:'सबसे मज़बूत औपचारिक संकेत; इसमें सामान्यतः सबसे अधिक समय और लागत लगती है।'}
    : {direct:'అత్యంత వేగవంతమైన మార్గం; స్వయంగా ఆధారాలు, కేంద్రీకృత అభ్యాసం అవసరం.', stepping_stone:'తక్కువ ప్రమాద మార్గం; పర్యవేక్షిత సాధనతో ఆదాయం, ఆధారాలను కొనసాగిస్తుంది.', qualification_first:'బలమైన అధికారిక సంకేతం; సాధారణంగా ఎక్కువ సమయం, ఖర్చు అవసరం.'};
