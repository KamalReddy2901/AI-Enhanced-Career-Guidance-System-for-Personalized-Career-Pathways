...
import { Clock, Home, Sparkles, FlaskConical, Scale, Settings } from 'lucide-react';
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-0.5 sm:gap-1">
          ...
          {isAIEnabled && (
            <div
              className="ml-1 hidden lg:flex items-center gap-1 px-2 py-1 bg-black/3 rounded-sm text-black/25"
