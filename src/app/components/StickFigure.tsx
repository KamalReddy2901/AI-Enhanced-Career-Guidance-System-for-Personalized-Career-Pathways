...
function renderPose(pose: StickFigurePose) {
  ...
  switch (pose) {
    ...
    case 'mapping':
      return <g stroke={s} strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round"><GroundShadow/><circle cx="60" cy="22" r="10"/><line x1="60" y1="32" x2="60" y2="65"/><line x1="60" y1="65" x2="48" y2="99"/><line x1="60" y1="65" x2="73" y2="99"/><motion.path d="M22 50l24-7 27 7 25-8v28l-25 8-27-7-24 7zM46 43v28M73 50v28" fill="var(--paper-raised)" animate={{rotate:[-1,1,-1]}} transition={{repeat:Infinity,duration:3}}/><line x1="60" y1="45" x2="44" y2="54"/><line x1="60" y1="45" x2="76" y2="55"/></g>;
